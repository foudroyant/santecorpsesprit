...
import 'livres_docteur_old_model.dart';
export 'livres_docteur_old_model.dart';

class LivresDocteurOldWidget extends StatefulWidget {
  const LivresDocteurOldWidget({super.key});

  @override
  State<LivresDocteurOldWidget> createState() => _LivresDocteurOldWidgetState();
}

class _LivresDocteurOldWidgetState extends State<LivresDocteurOldWidget> {
  late LivresDocteurOldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LivresDocteurOldModel());
